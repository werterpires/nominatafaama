...
export class EvangExpTypesModel {
  ...
  async createEvangExpType({ evang_exp_type_name }: ICreateEvangExpType): Promise<IEvangExpType> {
  ...
  async updateEvangExpTypeById(updateEvangExpType: IUpdateEvangExpType): Promise<IEvangExpType> {
