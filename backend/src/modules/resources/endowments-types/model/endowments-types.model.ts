...
export class EndowmentTypesModel {
  ...
  async createEndowmentType({ endowment_type_name, application }: ICreateEndowmentType): Promise<IEndowmentType> {
  ...
  async findEndowmentTypesByCategory(category: string): Promise<IEndowmentType[]> {
    let endowmentTypesList: IEndowmentType[] = [];
    let sentError: Error | null = null;
  ...
  async updateEndowmentTypeById(updateEndowmentType: IUpdateEndowmentType): Promise<IEndowmentType> {
    let updatedEndowmentType: IEndowmentType | null = null;
    let sentError: Error | null = null;

    await this.knex.transaction(async (trx) => {
      try {
        const { endowment_type_name, application, endowment_type_id } = updateEndowmentType;
        ...
        updatedEndowmentType = await this.findEndowmentTypeById(endowment_type_id);
