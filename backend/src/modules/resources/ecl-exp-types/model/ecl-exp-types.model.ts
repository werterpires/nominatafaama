...
export class EclExpTypesModel {
  ...
  async createEclExpType({ ecl_exp_type_name }: ICreateEclExpType): Promise<IEclExpType> {
  ...
  async updateEclExpTypeById(updateEclExpType: IUpdateEclExpType): Promise<IEclExpType> {
