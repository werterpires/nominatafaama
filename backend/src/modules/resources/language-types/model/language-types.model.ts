...
export class LanguageTypesModel {
  ...
  async createLanguageType({ language }: ICreateLanguageType): Promise<ILanguageType> {
  ...
  async updateLanguageTypeById(updateLanguageType: IUpdateLanguageType): Promise<ILanguageType> {
