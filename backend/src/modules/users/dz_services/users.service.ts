    ...
    try {
      ...
      const mailOptions = {
        ...
        <div style="background-color: #202c3d; color: white; font-family: 'Poppins', sans-serif; padding: 20px; border-radius: 10px">
          <h1 style="text-align: center; text-transform: uppercase">Recuperação de senha</h1>
          <p>Este é um email automático e foi enviado porque você solicitou alteração de senha por esquecimento.</p> </hr>
          <p>Utilize o código <b>${pass}</b> no campo de recuperação de senha para trocar sua senha.</p></hr></hr>
