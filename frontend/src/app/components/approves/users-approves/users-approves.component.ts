...
export class UsersApprovesComponent {
  ...
  ngOnInit():void{
    this.userServices.findAllUsers().subscribe({
      ...
      next: res => {
        ...
        this.repUsersNull = this.userServices.filterUsers(null, this.allUsers, 5)
        this.repUsersFalse = this.userServices.filterUsers(0, this.allUsers, 5)
        this.repUsersTrue = this.userServices.filterUsers(1, this.allUsers, 5)
        this.dirUsersNull = this.userServices.filterUsers(null, this.allUsers, 4)
        this.dirUsersFalse = this.userServices.filterUsers(0, this.allUsers, 4)
        this.dirUsersTrue = this.userServices.filterUsers(1, this.allUsers, 4)
        this.secUsersNull = this.userServices.filterUsers(null, this.allUsers, 3)
        this.secUsersFalse = this.userServices.filterUsers(0, this.allUsers, 3)
        this.secUsersTrue = this.userServices.filterUsers(1, this.allUsers, 3)
        this.docUsersNull = this.userServices.filterUsers(null, this.allUsers, 2)
        this.docUsersFalse = this.userServices.filterUsers(0, this.allUsers, 2)
        this.docUsersTrue = this.userServices.filterUsers(1, this.allUsers, 2)
  ...
  approveUser(approveRadio:string, rejectRadio:string, user_id:number, roles:IRole[]){
    this.isLoading= true
    
    
    const approveInput = document.getElementById(approveRadio) as HTMLInputElement;
    ...
    this.usersApprovesServices.approveUser({user_id, user_approved:approved, roles}).subscribe({
