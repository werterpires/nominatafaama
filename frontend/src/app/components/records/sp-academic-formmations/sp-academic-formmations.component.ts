...
export class SpAcademicFormmationsComponent {
  ...
  createSpAcademicFormation(){
    this.isLoading = true
    this.createSpAcademicFormationData.degree_id = Number(this.createSpAcademicFormationData.degree_id)
    this.spAcademicFormationService.createSpAcademicFormation(this.createSpAcademicFormationData).subscribe({
      next: res => {
  ...
  editSpAcademicFormation(i:number, buttonId:string){
    ...
    const editFormationData:ISpUpdateAcademicFormation = {
      ...
      conclusion_date: this.spAllFormations[i].conclusion_date? this.spAllFormations[i].conclusion_date:null,
      formation_id: this.spAllFormations[i].formation_id
    }

    this.spAcademicFormationService.editSpAcademicFormation(editFormationData).subscribe({
      next: res => {
