...
import { IEvangExpType, ICreateEvangExpTypeDto, IUpdateEvangExpType } from './types';
...
export class EvangExpTypesComponent {
  ...
  createEvangExpType(){
    this.isLoading = true;
    this.evangExpTypesService.createEvangExpType(this.createEvangExpTypeData).subscribe({
      next: res => {
        this.doneMessage = 'Tipo de experiência evangélica criado com sucesso.';
        this.done = true;
        this.isLoading = false;
        this.ngOnInit();
