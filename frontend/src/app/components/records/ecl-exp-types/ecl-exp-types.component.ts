...
import { ICreateEclExpTypeDto, IEclExpType } from './types'
...
export class EclExpTypesComponent {
  ...
  allRegistries: IEclExpType[] = []
  title = 'Tipos de Experiências Eclesiásticas'
  createRegistryData: ICreateEclExpTypeDto = {
    ecl_exp_type_name: '',
  }
  ...
  constructor(private service: EclExpTypesService) {}
