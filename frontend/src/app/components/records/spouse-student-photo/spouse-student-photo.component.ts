...
import { SpouseStudentPhotosService } from './spouse-student-photo.service'
...
@Component({
  selector: 'app-spouse-student-photo',
  templateUrl: './spouse-student-photo.component.html',
  styleUrls: ['./spouse-student-photo.component.css'],
})
export class SpouseStudentPhotoComponent {
  @Input() permissions!: IPermissions
  allRegistries: IStudentPhoto[] = []
  title = 'Foto do cônjuge do estudante'
  ...
  error = false
  errorMessage = ''
  constructor(private service: SpouseStudentPhotosService) {}
  ngOnInit() {
